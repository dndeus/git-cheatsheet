...
```
git fsck			# It checks for all the "dangling blobs" in the .git directory. Then i.e. git show f24facc98b387a375a50ba6d19193626cbfe7d45 > restored_file.txt
```
...
git checkout bugfi			# Switches to the bugfix branch
